...
forward LoadVehicle_data(playerid,name[],value[],VehNum);
public LoadVehicle_data(playerid,name[],value[],VehNum)
{
	switch(VehNum){
		case 1: {INI_Bool("VehicleOwned",VehicleInfo1[playerid][VehicleOwned]);
				 ...
				 return 0;}
		case 2: {INI_Bool("VehicleOwned",VehicleInfo2[playerid][VehicleOwned]);
